...
//       try {
//         const teacherResponse = await fetch("http://54.206.210.62:1337/teacher");
...
//     try {
//       const response = await axios.get(`http://54.206.210.62:1337/teacherFind/byDesignation?designation=${selectedDesignation}`)
