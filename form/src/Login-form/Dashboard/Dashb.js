...
//       try {
//         const response = await fetch("http://54.206.210.62:1337/getCountStudent");
...
//           "http://54.206.210.62:1337/getCountByDepartmentStudent"
//         );
//         const data = await response.json();
...
//     try {
//       const response = await fetch("http://54.206.210.62:1337/count");
//       const data = await response.json();
...
//      try {
//        const response = await fetch("http://54.206.210.62:1337/countByDepartment");
//        const data = await response.json();
...
//       try {
//         const response = await fetch("http://54.206.210.62:1337/teacher");
//         const data = await response.json();
...
//        try {
//          const response = await fetch("http://54.206.210.62:1337/fetchAllstudent");
//          const data = await response.json();
  ...
  renderStudentChart() {
    ...
    if (this.studentChartRef.current) {
      ...
      this.studentChartRef.current.onclick = async (event) => {
        const activePoints =
          this.studentChartInstance.getElementsAtEventForMode(
            event,
            "nearest",
            { intersect: true },
            true
        ...
        if (activePoints.length > 0) {
          ...
          try {
            const response = await axios.get(
              "http://54.206.210.62:1337/students/byDepartment",
              {
                params: {
